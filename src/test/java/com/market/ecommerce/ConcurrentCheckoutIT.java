...
public class ConcurrentCheckoutIT {
    ...
    void setup() {
        ...
        Address addrA = Address.builder().user(a).line1("addr A").city("C").postalCode("1000").build();
        Address addrB = Address.builder().user(b).line1("addr B").city("C").postalCode("1001").build();
    ...
    private String extractTokenFromResponse(ResponseEntity<String> resp) {
        // crude extraction from JSON: look for "token":"..."
